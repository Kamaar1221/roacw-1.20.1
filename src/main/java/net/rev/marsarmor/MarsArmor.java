...
@Mod(MarsArmor.MODID)
public class MarsArmor
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "mars_armor";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public MarsArmor(FMLJavaModLoadingContext context)
    {
        IEventBus modEventBus = context.getModEventBus();

        MarsItems.register(modEventBus);
        MarsArmorBlocks.register(modEventBus);
